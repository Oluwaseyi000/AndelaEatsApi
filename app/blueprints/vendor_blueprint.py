...
@vendor_blueprint.route('/<string:vendor_id>', methods=['GET'])
...
@Security.validator([
	'name|required', 'address|required', 'tel|required:string', 'isActive|required:boolean', 'contactPerson|required'])
@swag_from('documentation/create_vendor.yml')
def create_vendor():
	return vendor_controller.create_vendor()


@vendor_blueprint.route('/<string:vendor_id>', methods=['PUT', 'PATCH'])
@Security.validator([
	'name|required', 'address|required', 'tel|required:string', 'isActive|required:boolean', 'contactPerson|required'])
...
@vendor_blueprint.route('/un_suspend/<string:vendor_id>', methods=['PUT', 'PATCH'])
...
@vendor_blueprint.route('/suspend/<string:vendor_id>', methods=['PUT', 'PATCH'])
@swag_from('documentation/suspend_vendor.yml')
def suspend_vendor(vendor_id):
	return vendor_controller.suspend_vendor(vendor_id)


@vendor_blueprint.route('/<string:vendor_id>', methods=['DELETE'])
